...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        Application app1 = application(cand1, job1, ApplicationStatus.INTERVIEW, LocalDateTime.now().minusDays(9),
                "/cv/mai_tran.pdf");
        Application app2 = application(cand2, job1, ApplicationStatus.SCREENING, LocalDateTime.now().minusDays(7),
                "/cv/nam_le.pdf");
        ...
        Application app6 = application(cand4, job2, ApplicationStatus.HIRED, LocalDateTime.now().minusDays(20),
                "/cv/lan_vo.pdf");
        Application app7 = application(cand3, job3, ApplicationStatus.REJECTED, LocalDateTime.now().minusDays(11),
                "/cv/long_pham.pdf");
        Application app8 = application(cand4, job1, ApplicationStatus.WITHDRAWN, LocalDateTime.now().minusDays(8),
                "/cv/lan_vo.pdf");
        ...
        activityLog(admin, EventType.ACCOUNT_LOCKED, "Account locked after failed attempts: lan_vo", "192.168.1.10",
                LocalDateTime.now().minusDays(2));
        activityLog(hr, EventType.SIGN_IN_SUCCESS, "HR signed in", "192.168.1.22", LocalDateTime.now().minusDays(1));
        activityLog(hr, EventType.APPLICATION_STATUS_CHANGED, "Application #app1 moved to INTERVIEW", "192.168.1.22",
                LocalDateTime.now().minusDays(5));
